...
<form action="/searchactiveuser" method="POST" role="search">
    {{ csrf_field() }}
    <div class="row">
      <div class="col-md-7">
          <h3>Active users</h3>
    ...
    <tbody>
     ...
     @if( $user->state == 'Active' )
      <tr>
        ...
        <td style="text-align:center"> <a href="{{action('ActiveUserController@edit', $user->user_id)}}" class="btn btn-outline-success">Deactive</a></td>
      </tr>
      @endif
      @endforeach
    </tbody>
